Imports System.Data
Imports Mensaje
Partial Class Siniestros_ReporteListadoPagosStros
...
#Region "Eventos"
    ...
    Private Sub btnReporte_Click(sender As Object, e As EventArgs) Handles btnReporte.Click
        If ValidaFiltros() Then
            GeneraReporte()
            CargarCombos()
            MuestraMensaje("Listado de pago de siniestros", "Reporte generado con éxito.", TipoMsg.Advertencia)
        End If
    End Sub
#End Region
...
#Region "Métodos"
    ...
    Private Sub GeneraReporte()
        ...
        RptFilters = "&Fec_auto_ini=" & Funciones.FormatearFecha(txt_fec_gen_desde.Text, Funciones.enumFormatoFecha.YYYYMMDD) +
        ...
        server = Replace(Replace(server, "@Reporte", "Rpt_op_web_pagos_stro"), "@Formato", "EXCEL")
