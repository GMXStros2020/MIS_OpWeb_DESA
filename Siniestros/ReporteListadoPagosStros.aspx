<%@ Page Title="" Language="VB" MasterPageFile="~/Pages/SiteMaster.master" AutoEventWireup="false" CodeFile="ReporteListadoPagosStros.aspx.vb" Inherits="Siniestros_ReporteListadoPagosStros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_principal" Runat="Server">
    ...
    <div style="overflow-x: hidden">
        <div class="cuadro-titulo panel-encabezado">
            ...
            Listado de Pagos de Siniestros
        </div>
