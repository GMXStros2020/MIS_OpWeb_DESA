        ...
        Try
            ...
            Select Case cmbTipoUsuario.SelectedValue
                ...
                Case eTipoUsuario.Proveedor
                    ...
                    Me.txtTotalAutorizacion.Text = String.Format("{0:0,0.00}", 0)
                    Me.txtTotalImpuestos.Text = String.Format("{0:0,0.00}", 0)
                    Me.txtTotalRetenciones.Text = String.Format("{0:0,0.00}", 0)
        ...
        Try
            If cmbTipoUsuario.SelectedValue = eTipoUsuario.Proveedor Then
                ...
                Else
                    ...
                    End If
                End If
                If Decimal.Parse(txtTotalFac.Text) = 0 And Decimal.Parse(iptxtTotal.Text) = 0 Then
                    ValidarImpuestosOPFac = False
                    Mensaje.MuestraMensaje("OrdenPagoSiniestros", "Favor de validar los importes.", TipoMsg.Falla)
                End If

                If Decimal.Parse(txtTotalFac.Text) < 0 And Decimal.Parse(iptxtTotal.Text) < 0 Then
                    ValidarImpuestosOPFac = False
                    Mensaje.MuestraMensaje("OrdenPagoSiniestros", "Favor de ingresar un importe valido.", TipoMsg.Falla)
                End If
            Else
    ...
    Public Sub GenerarOrdenPago() Handles btnGrabarOP.Click
        ...
        Try
            ...
            If ValidarImpuestosOPFac() = True Then
                ...
                If iptxtTotal.Text = "" Then
                    iptxtTotal.Text = 0
                End If

                If CDbl(iptxtTotal.Text) < 0 Or CDbl(iptxtTotal.Text) = 0 Then
                    Mensaje.MuestraMensaje("OrdenPagoSiniestros", "Favor de validar los importes.", TipoMsg.Falla)
                    Return
                End If
...
#End Region
    ...
    Private Sub drDependencias_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drDependencias.SelectedIndexChanged
        ...
        Else
            ...
            txtcpto2.Text = txtcpto2.Text + " " + cpto2
        End If
    End Sub
