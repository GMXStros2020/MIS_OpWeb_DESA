                                 ...
                                 <Columns>
                                   ...
                                   <ItemStyle HorizontalAlign="Center" Width="20px"></ItemStyle>
                                     ...
                                     <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ReadOnly="true" ID="Jefe_" runat="server" Text='<%# If(CBool(Eval("Jefe") = "RRAMOS") Or CBool(Eval("Solicitante") = "RRAMOS"), "", Eval("NombreJefe")) %>' ForeColor='<%# If(CBool(Eval("usu_solrechazo") = Eval("Jefe")), System.Drawing.Color.White, System.Drawing.Color.Black) %>' BackColor='<%# If(CBool(Eval("Rechazada")), System.Drawing.Color.LightBlue, If(CBool(Eval("usu_solrechazo") = Eval("Jefe")), System.Drawing.Color.Red, If(CBool(Eval("FirmadoJefe")) And CBool(IsDBNull(Eval("FechaFirmaJefe"))), System.Drawing.Color.LightGray, If(CBool(Eval("FirmadoJefe")), System.Drawing.Color.LimeGreen, If(Eval("NivelAutorizacion") >= 1 And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, System.Drawing.Color.Bisque))))) %>'  Width="100px"></asp:Label>
                                        </ItemTemplate>
