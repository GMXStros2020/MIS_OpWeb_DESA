<%@ Page Title="" Language="VB" MasterPageFile="~/Pages/SiteMaster.master" AutoEventWireup="false" CodeFile="AutElectTrad.aspx.vb" Inherits="Siniestros_AutElectTrad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_principal" Runat="Server">
    ...
    <div class="zona-principal" style="overflow-x:hidden;overflow-y:hidden">
        <div class="cuadro-titulo panel-encabezado">
            ...
            Filtros - Autorizaciones Electr&oacute;nicas Tradicional
        </div>
        ...
        <div class="panel-contenido ventana1">
                <asp:UpdatePanel runat="server" ID="upOrdenes" >
                  <ContentTemplate>
                      ...
                      <asp:Label Text="Sin Firmar" class="etiqueta-control" Font-Bold="true"  BackColor="Orange" runat="server" ></asp:Label>
                             ...
                             <asp:GridView runat="server" ID="grdOrdenPago" Width="1500px" AutoGenerateColumns="false"  ShowHeader="True"
                                 ...
                                 <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ReadOnly="True" runat="server" Text='<%# Eval("Contratante") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                     ...
                                     <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ReadOnly="true" ID="Gerente_" runat="server" Text='<%# If(CBool(Eval("Gerente") = "RRAMOS") Or CBool(Eval("Solicitante") = "RRAMOS"), "", Eval("NombreGerente")) %>' ForeColor='<%# If(CBool(Eval("usu_solrechazo") = Eval("Gerente")), System.Drawing.Color.White, System.Drawing.Color.Black) %>' BackColor='<%# If(CBool(Eval("Rechazada")), System.Drawing.Color.LightBlue, If(CBool(Eval("usu_solrechazo") = Eval("Gerente")), System.Drawing.Color.Red, If(CBool(Eval("FirmadoGerente")) And CBool(IsDBNull(Eval("FechaFirmaGerente"))), System.Drawing.Color.LightGray, If(CBool(Eval("FirmadoGerente")), System.Drawing.Color.LimeGreen, If(Eval("NivelAutorizacion") >= 3 And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, If(Eval("NivelAutorizacion") >= 2 And CBool(Eval("Subgerente") = "") And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, System.Drawing.Color.Bisque)))))) %>'  Width="100px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="50px"></ItemStyle>
                                    </asp:TemplateField>   
                                     ...
                                     <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ReadOnly="true" ID="Subdirector_" runat="server" Text='<%# Eval("NombreSubdirector") %>' ForeColor='<%# If(CBool(Eval("usu_solrechazo") = Eval("Subdirector")), System.Drawing.Color.White, System.Drawing.Color.Black) %>' BackColor='<%# If(CBool(Eval("Rechazada")), System.Drawing.Color.LightBlue, If(CBool(Eval("usu_solrechazo") = Eval("Subdirector")), System.Drawing.Color.Red, If(CBool(Eval("FirmadoSubdirector")) And CBool(IsDBNull(Eval("FechaFirmaSubdirector"))), System.Drawing.Color.LightGray, If(CBool(Eval("FirmadoSubdirector")), System.Drawing.Color.LimeGreen, If(Eval("NivelAutorizacion") >= 4 And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, If(Eval("NivelAutorizacion") >= 3 And CBool(Eval("Gerente") = "") And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, System.Drawing.Color.Bisque)))))) %>'  Width="100px"></asp:Label>
                                        </ItemTemplate>
                                         <ItemStyle HorizontalAlign="Center" Width="50px"></ItemStyle>
                                    </asp:TemplateField> 
                                     ...
                                     <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ReadOnly="true" ID="Director_" runat="server" Text='<%# Eval("NombreDirector") %>' ForeColor='<%# If(CBool(Eval("usu_solrechazo") = Eval("Director")), System.Drawing.Color.White, System.Drawing.Color.Black) %>' BackColor='<%# If(CBool(Eval("Rechazada")), System.Drawing.Color.LightBlue, If(CBool(Eval("usu_solrechazo") = Eval("Director")), System.Drawing.Color.Red, If(CBool(Eval("FirmadoDirector")) And CBool(IsDBNull(Eval("FechaFirmaDirector"))), System.Drawing.Color.LightGray, If(CBool(Eval("FirmadoDirector")), System.Drawing.Color.LimeGreen, If(Eval("NivelAutorizacion") >= 5 And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, If(Eval("NivelAutorizacion") >= 4 And CBool(Eval("Subdirector") = "") And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, System.Drawing.Color.Bisque)))))) %>'  Width="100px"></asp:Label>
                                        </ItemTemplate>
                                         <ItemStyle HorizontalAlign="Center" Width="50px"></ItemStyle>
                                    </asp:TemplateField>
                                      ...
                                      <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ReadOnly="true" ID="DirectorEjecutivo_" runat="server" Text='<%# Eval("NombreDirectorEjecutivo") %>' ForeColor='<%# If(CBool(Eval("usu_solrechazo") = Eval("DirectorEjecutivo")), System.Drawing.Color.White, System.Drawing.Color.Black) %>' BackColor='<%# If(CBool(Eval("Rechazada")), System.Drawing.Color.LightBlue, If(CBool(Eval("usu_solrechazo") = Eval("DirectorEjecutivo")), System.Drawing.Color.Red, If(CBool(Eval("FirmadoDirectorEjecutivo")) And CBool(IsDBNull(Eval("FechaFirmaDirectorEjecutivo"))), System.Drawing.Color.LightGray, If(CBool(Eval("FirmadoDirectorEjecutivo")), System.Drawing.Color.LimeGreen, If(Eval("NivelAutorizacion") >= 6 And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, If(Eval("NivelAutorizacion") >= 5 And CBool(Eval("Director") = "") And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, System.Drawing.Color.Bisque)))))) %>'  Width="100px"></asp:Label>
                                        </ItemTemplate>
                                         <ItemStyle HorizontalAlign="Center" Width="50px"></ItemStyle>
                                    </asp:TemplateField>
                                     ...
                                     <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ReadOnly="true" ID="DirectorGeneral_" runat="server" Text='<%# Eval("NombreDirectorGeneral") %>' ForeColor='<%# If(CBool(Eval("usu_solrechazo") = Eval("DirectorGeneral")), System.Drawing.Color.White, System.Drawing.Color.Black) %>' BackColor='<%# If(CBool(Eval("Rechazada")), System.Drawing.Color.LightBlue, If(CBool(Eval("usu_solrechazo") = Eval("DirectorGeneral")), System.Drawing.Color.Red, If(CBool(Eval("FirmadoDirectorGeneral")), System.Drawing.Color.LimeGreen, If(Eval("NivelAutorizacion") >= 7 And Eval("Preautorizada") <> 1, System.Drawing.Color.Orange, System.Drawing.Color.Bisque)))) %>' Width="100px"></asp:Label>
                                        </ItemTemplate>
                                         <ItemStyle HorizontalAlign="Center" Width="50px"></ItemStyle>
                                    </asp:TemplateField>  
                                     <asp:TemplateField>
                                   ...
                                   <%--   <asp:TemplateField HeaderText="OP" ItemStyle-Width="60px" HeaderStyle-Width>
                                      ...
                                      <asp:TemplateField HeaderText="EdoCta" ItemStyle-Width="60px">
                                            <ItemTemplate>
                                      ...
                                      <asp:TemplateField HeaderText="Docs" ItemStyle-Width="60px">
                                            <ItemTemplate>
                                                    <asp:imagebutton ID="btn_VerDocs" ImageUrl="~/Images/pdf14.png" Height="26" CommandName="VerDocs" CommandArgument="<%# Container.DataItemIndex %>" runat="server"/>
                                            </ItemTemplate>
                                    </asp:TemplateField>
