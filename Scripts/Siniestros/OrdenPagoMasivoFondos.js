    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (mydata.length != 0) {
                ...
                //$($("#list47").find("tr[id='" + id + "']").find("td[aria-describedby='list47_Concepto2']").find("input")).val(vConcepto2);
                
                $("#list47").find(`tr[id='${id}'] td[aria-describedby='list47_Concepto2'] input`).val(vConcepto2);
